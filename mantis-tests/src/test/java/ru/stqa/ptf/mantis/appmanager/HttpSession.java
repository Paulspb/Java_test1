...
/**
 * Created by khomep on 28-Jul-16.
 */
public class HttpSession {
    ...
    public HttpSession(ApplicationManager app) {
            // pomownik known what manager is he
            // in Http session pass link 'app', then remind it,
            //   next
        this.app = app;
                // where building is fluent interface
                // LaxRedirectStrategy() self-define of redirection for HTTP-request
